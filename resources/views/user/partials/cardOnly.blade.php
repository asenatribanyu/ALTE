@foreach ($formulirs as $formulir)
    <article
        ...
        <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">One of the things I always loved about the web is
            its
        ...
        <div class="flex gap-2">
            ...
            @auth
                <button type="button" data-modal-target="upload-form-modal-{{ $formulir->id }}" data-modal-toggle="upload-form-modal-{{ $formulir->id }}"
