    ...
    <div class="flex justify-center mt-3">
        <div class="max-w-xl p-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 dark:bg-gray-800">
            ...
            <form class="space-y-4 md:space-y-5" method="POST" action="/admin/manage/users/store">
                ...
                <div>
                    <label for="password_comfirmation" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Konfirmasi
                        Kata
                        Sandi</label>
                ...
                <div class="flex gap-2">
                    <button type="button" data-modal-target="buat-akun-modal" data-modal-toggle="buat-akun-modal"
                        class="mt-4 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Kirim</button>
                    <a href="/admin/dashboard/artikel/foto"
