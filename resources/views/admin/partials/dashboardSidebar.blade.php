        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="/admin/manage/files"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Dokumen Mahasiswa</span>
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="/admin/manage/forms"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Pengelolaan Formulir</span>
                </a>
            </li>
        </ul>
    </div>
